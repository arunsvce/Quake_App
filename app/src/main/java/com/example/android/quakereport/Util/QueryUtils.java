...
public class QueryUtils {
    ...
    public static ArrayList<QuakeFlavor> extractEarthquakes(String earthquakeJson) {
        ...
        ArrayList<QuakeFlavor> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            JSONArray baseFeatures = root.getJSONArray("features");

            for (int i = 0; i < baseFeatures.length() ; i++) {

                JSONObject currentFeature = baseFeatures.getJSONObject(i);
...
//                Date dateObject = new Date(timeInMillieconds);
//                SimpleDateFormat dateFormat = new SimpleDateFormat("MMM DD ,yyyy");
//                dateToDisplay = dateFormat.format(dateObject);



              earthquakes.add(new QuakeFlavor(magnitude,location,timeInMilliseconds,url) );
    ...
    public static ArrayList<QuakeFlavor> fetchEarthquakeData(String requestUrl){
        ...
        ArrayList<QuakeFlavor> earthquakes = extractEarthquakes(jsonResponse); // jsonresponse;
